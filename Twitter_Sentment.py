...
#        pos_sent = open("positive_words.txt").read()
        pos_sent = open("E:\\Edureka\\Class PDF\\Class_10\\Module10Scripts\\positive_words.txt").read()
        positive_words = pos_sent.split('\n')
        positive_counts = []
        neg_sent = open('E:\\Edureka\\Class PDF\\Class_10\\Module10Scripts\\negative_words.txt').read()
